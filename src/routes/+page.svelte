...
<section class="flex flex-row items-center justify-between py-3 pl-4 pr-6">
	<h1>Carrinho da nuvem</h1>
</section>
...
<ul class="bg-base-200 py-2">
	...
	{:else}
		<section
			class="p-4 bg-neutral space-y-4 border divide-y animate-pulse divide-base-300 md:p-6 border-base-300"
		>
			<div class="flex justify-between items-center">
				...
				<div class="h-2.5  rounded-full bg-base-200 w-12" />
			</div>
